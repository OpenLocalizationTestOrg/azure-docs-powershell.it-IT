...
<span data-ttu-id="d9666-133">Eseguire questo comando da una nuova sessione di PowerShell.</span><span class="sxs-lookup"><span data-stu-id="d9666-133">Run this command from a new PowerShell session.</span></span> <span data-ttu-id="d9666-134">Dopo aver eseguito correttamente l'accesso, verrà visualizzato un output simile al seguente:</span><span class="sxs-lookup"><span data-stu-id="d9666-134">After a successfully signing on you see output something like this:</span></span>
...
<span data-ttu-id="d9666-142">Azure PowerShell fornisce i cmdlet seguenti per gestire le assegnazioni dei ruoli:</span><span class="sxs-lookup"><span data-stu-id="d9666-142">Azure PowerShell provides the following cmdlets to manage role assignments:</span></span>

* [<span data-ttu-id="d9666-143">Get-AzureRmRoleAssignment</span><span class="sxs-lookup"><span data-stu-id="d9666-143">Get-AzureRmRoleAssignment</span></span>](/powershell/module/azurerm.resources/get-azurermroleassignment)
* [<span data-ttu-id="d9666-144">New-AzureRmRoleAssignment</span><span class="sxs-lookup"><span data-stu-id="d9666-144">New-AzureRmRoleAssignment</span></span>](/powershell/module/azurerm.resources/new-azurermroleassignment)
* [<span data-ttu-id="d9666-145">Remove-AzureRmRoleAssignment</span><span class="sxs-lookup"><span data-stu-id="d9666-145">Remove-AzureRmRoleAssignment</span></span>](/powershell/module/azurerm.resources/remove-azurermroleassignment)

<span data-ttu-id="d9666-146">Il ruolo predefinito per un'entità servizio è quello **Collaboratore**.</span><span class="sxs-lookup"><span data-stu-id="d9666-146">The default role for a service principal is **Contributor**.</span></span> <span data-ttu-id="d9666-147">Potrebbe non essere la scelta migliore in base allo scope delle interazioni dell'app con i servizi di Azure, date le ampie autorizzazioni.</span><span class="sxs-lookup"><span data-stu-id="d9666-147">It may not be the best choice depending on the scope of your app's interactions with Azure services, given its broad permissions.</span></span>
<span data-ttu-id="d9666-148">Il ruolo **Lettore** è più restrittivo e può essere una buona scelta per le app di sola lettura.</span><span class="sxs-lookup"><span data-stu-id="d9666-148">The **Reader** role is more restrictive and can be a good choice for read-only apps.</span></span> <span data-ttu-id="d9666-149">È possibile visualizzare i dettagli delle autorizzazioni specifiche del ruolo o creare autorizzazioni personalizzate tramite il portale di Azure.</span><span class="sxs-lookup"><span data-stu-id="d9666-149">You can view details on role-specific permissions or create custom ones through the Azure portal.</span></span>

<span data-ttu-id="d9666-150">In questo esempio si aggiunge il ruolo**Lettore** all'esempio precedente e si elimina quello **Collaboratore**:</span><span class="sxs-lookup"><span data-stu-id="d9666-150">In this example, we add the **Reader** role to our prior example, and delete the **Contributor** one:</span></span>
...
<span data-ttu-id="d9666-151">Per visualizzare i ruoli correnti assegnati:</span><span class="sxs-lookup"><span data-stu-id="d9666-151">To view the current roles assigned:</span></span>
...
<span data-ttu-id="d9666-152">Altri cmdlet di Azure PowerShell per la gestione dei ruoli:</span><span class="sxs-lookup"><span data-stu-id="d9666-152">Other Azure PowerShell cmdlets for role management:</span></span>

* [<span data-ttu-id="d9666-153">Get-AzureRmRoleDefinition</span><span class="sxs-lookup"><span data-stu-id="d9666-153">Get-AzureRmRoleDefinition</span></span>](/powershell/module/azurerm.resources/Get-AzureRmRoleDefinition)
* [<span data-ttu-id="d9666-154">New-AzureRmRoleDefinition</span><span class="sxs-lookup"><span data-stu-id="d9666-154">New-AzureRmRoleDefinition</span></span>](/powershell/module/azurerm.resources/New-AzureRmRoleDefinition)
