...
### <a id="update-azps"></a><span data-ttu-id="2f6aa-149">Eseguire l'aggiornamento a una nuova versione di Azure PowerShell</span><span class="sxs-lookup"><span data-stu-id="2f6aa-149">Updating to a new version of Azure PowerShell</span></span>
